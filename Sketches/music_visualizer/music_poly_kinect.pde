...
Draws a FPoly shape of the wave and adds it to the physics world every 60 frames.
...
//    Take Music Poly 3 and Change it so instead of making the wave a poly, collect the kinect data once each time
import fisica.*;
import ddf.minim.*;
